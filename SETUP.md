...
Go to [Feishu Open Platform](https://open.feishu.cn/app) → Create Custom App.
...
In the Feishu app console → Bot, enable the bot capability. Users can then DM the bot to chat with your AI team.
